...
> **R-Info-Evolution** is a revitalization and modernization of the classic R-info programming environment used at the UNLP School of Computer Science. This project takes a fundamental educational tool and adapts it to current development standards by optimizing its architecture, enhancing performance, and streamlining the experience for the next generation of programming and logic students.

---

## Estado del Proyecto y Ramas (Branches)
...
* **[`dev`](https://github.com/DylanGonzaloFerreyra/R-Info-Evolution/tree/dev)):** Es donde ocurre la "Evolución". En esta rama estoy trabajando activamente en:
    ...
    * Traduccion y adaptacion a más idiomas.
...
Abrí una terminal (`Ctrl+Alt+T`) y seguí estos pasos:
...
*Basado en la definición de [Ationno/R-Info-Web](https://www.google.com/search?q=https://github.com/Ationno/R-Info-Web).*

Es un lenguaje de programación diseñado para aprender las nociones básicas de la programación y brindar soporte para la enseñanza del **paradigma concurrente**.

Se desarrolla en un entorno donde el objetivo es lograr que "robots" realicen tareas específicas bajo un set de instrucciones determinado. Todo esto sucede en el contexto de un mapa bidimensional denominado **ciudad**.

---

## Documentación del Lenguaje R-Info

*El siguiente contenido es una es una copia textual de la documentación oficial mantenida por [Ationno en R-Info-Web](https://github.com/Ationno/R-Info-Web/blob/main/LENGUAGE_DOCUMENTATION.md) para las versiones 2.8/9 (posiblemente desactualizada con respecto a la version 3.1).*
